package experiments.experiment6b;
...
public class Experiment6b extends Experiment {
	@Override
	...
	public Experiment6b() {
		...
		try {
			...
			Instance cube = world.associate(m, world.addCoordSystem(Vector.X.multiply(1), Vector.Y.multiply(1),
					Vector.Z.multiply(1), new Vector(0, -3, -10)), t, true, false);

			t = world.addTransformation(3000);
			t.rotateZ(180, 1000);
			world.associate(cube, world.addCoordSystem(Vector.X, Vector.Y, Vector.O), t, true, true);
	...
	public static void prepare(Container mainContainer) {
		prepare(mainContainer, new Experiment6b());
	}

	public static void main(String[] args) {
		JFrame frame = new JFrame("Experiment 6b");
